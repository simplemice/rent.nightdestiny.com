...
$carId = $car['id'];
$_carLink = '/car.php?'.http_build_query($request->getPayload());
                ...
                <div class="car-box">
                    ...
                    <div class="car-tabs">
                        ...
                        <div class="car-content">
                            <ul class="pl-0">
                                <li class="list-inline-item"><span class="icon-check"></span> СТРАХОВКА ПЕРВОГО ИЛИ БИЗНЕС КЛАССА</li>
                                <li class="list-inline-item"><span class="icon-check"></span> ЗАЩИТА ОТ ОТВЕТСТВЕННОСТИ ПЕРЕД ТРЕТЬИМИ ЛИЦАМИ</li>
                                <li class="list-inline-item"><span class="icon-check"></span> ЗАЩИТА ОТ КРАЖИ</li>
                                <li class="list-inline-item"><span class="icon-check"></span> НЕОГРАНИЧЕННЫЙ ПРОБЕГ</li>
                                <li class="list-inline-item"><span class="icon-check"></span> ВЫЕЗД ЗА ПРЕДЕЛЫ ПХУКЕТА</li>
                                ...
                                <li class="list-inline-item"><span class="icon-check"></span> ДОПОЛНИТЕЛЬНЫЙ ВОДИТЕЛЬ</li>
                            </ul>
                        </div>
                    </div>
