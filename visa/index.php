...
<head>
    ...
    <title>Дешевые визы на Пхукете!</title>
    <meta name="robots" content="index, follow">
    <meta name="description" content="Дешевые визы на Пхукете, звоните прямо сейчас и получите специальную скидку WhatsApp +66650210421">
<!-- Google tag (gtag.js) -->
...
<section>
    <div class="container">
         <div class="row">
             <marquee>
                 <span>Мечтаете открыть свой бизнес и начать работу в стране улыбок? Мы поможем!</span>
             </marquee> 
         ...
         <div class="row">
            ...
            <div class="col-md-7 col-lg-9 pp">
                ...
                <?php foreach ($store->getCarsByRequest($request) as $carId => $car): ?>
                    ...
                    $_carLink = '/visa/car.php?'.http_build_query(array_merge(['car' => $carId], $request->getPayload()));
                    ?>
                    <div class="car-box">
                        ...
                        <div class="car-tabs">
                            ...
                            <div class="car-content">
                                <ul class="pl-0">
                                    <li class="list-inline-item"><span class="icon-check"></span> ПОДГОТОВКА ВСЕХ ДОКУМЕНТОВ
                                    </li>
                                    <li class="list-inline-item">
                                        <span class="icon-check"></span> РУСКОЯЗЫЧНАЯ ПОДДЕРЖКА
                                    </li>
                                    <li class="list-inline-item"><span class="icon-check"></span> ВИЗОВАЯ ПОДДЕРЖКА 24/7
                                    </li>
                                </ul>
                            </div>
                        </div>
