...
?>
         			...
         			<a href="/yacht/assets/images/<?=$car['image']?>" data-toggle="lightbox"><img src="/yacht/assets/images/<?=$car['image']?>" class="img-fluid"></a>
                            ...
                            <div class="col-auto mr-auto car-info">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                     ...
                                     <li>
                                         <span class="fas fa-restroom"></span> <?=$car['toilet']?>
                                     </li>
                                      <li>
                                          <span class="fas fa-swimmer"></span> <?=$car['snork']?>
                                      </li>
                                </ul>
                            </div>
