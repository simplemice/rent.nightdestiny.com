...
<head>
    ...
    <title>Дешевая аренда яхт на Пхукете!</title>
    <meta name="robots" content="index, follow">
    <meta name="description" content="Лучший прокат яхт на Пхукете, звоните прямо сейчас и получите специальную скидку WhatsApp +66650210421">
<!-- Google tag (gtag.js) -->
...
<section>
    <div class="container">
         <div class="row">
             <marquee>
                 <span>Аренда яхты, приватные туры и многое другое!</span>
             </marquee> 
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-9 pp">
                ...
                <?php foreach ($store->getCarsByRequest($request) as $carId => $car): ?>
                    ...
                    $_carLink = '/yacht/car.php?'.http_build_query(array_merge(['car' => $carId], $request->getPayload()));
                    ?>
                    <div class="car-box">
                        ...
                        <div class="car-tabs">
                            ...
                            <div class="car-content">
                                <ul class="pl-0">
                                 <li class="list-inline-item"><span class="icon-check"></span>            СПАСАТЕЛЬНЫЕ ЖИЛЕТЫ</li>
                                 <li class="list-inline-item"><span class="icon-check"></span> ИНВЕНТАРЬ  ДЛЯ СНОРКЛИНГА</li>
                                 <li class="list-inline-item"><span class="icon-check"></span> ФРУКТЫ И   ПИТЬЕВАЯ ВОДА</li>
                                 <li class="list-inline-item"><span class="icon-check"></span>            РУСКОЯЗЫЧНАЯ ПОДДЕРЖКА</li>
                                 <li class="list-inline-item"><span class="icon-check"></span> ПОМОЩЬ НА  ВОДЕ 24/7</li>
                                </ul>
                            </div>
                        </div>
                    </div>
